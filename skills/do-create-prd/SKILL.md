...
## Resumption Detection (Stateless Environments: GitHub Copilot, Cursor AI, Opencode)
In GitHub Copilot, Cursor AI, and Opencode, each user message starts a fresh invocation — the agent has no memory of previous turns. To handle resumption:
...
1. Read the template at the path resolved in Step 0 (e.g., `.claude/skills/do-create-prd/assets/prd-template.md` for Claude Code, `.cursor/rules/do-create-prd/assets/prd-template.md` for Cursor AI, `.opencode/skills/do-create-prd/assets/prd-template.md` for Opencode).
...
1. **SYNC INTERNAL PROGRESS**: Once the PRD is saved, if `TaskUpdate` is available (Claude Code only; skip in Copilot, Cursor, and Opencode), use it to mark all corresponding items in your internal task tracking as `completed`. Otherwise, skip this step.
...
- If the template file is missing at the skills directory path (e.g., `.claude/skills/do-create-prd/assets/prd-template.md` for Claude Code, `.cursor/rules/do-create-prd/assets/prd-template.md` for Cursor AI, `.opencode/skills/do-create-prd/assets/prd-template.md` for Opencode), report the error and halt — do not generate a PRD without the template.
...
## References
- Template: resolved by environment (e.g., `.claude/skills/do-create-prd/assets/prd-template.md` for Claude Code, `.cursor/rules/do-create-prd/assets/prd-template.md` for Cursor AI, `.opencode/skills/do-create-prd/assets/prd-template.md` for Opencode)
